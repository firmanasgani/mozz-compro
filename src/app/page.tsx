export default function Home() {
  return (
    <div className="flex flex-col items-center justify-around h-screen">
      <div className="flex flex-row item-center justify-center mt-10" style={{ height: '1200px' }}>
        <div className="w-1/2 flex justify-center align-center">
          <h1 className="text-4xl font-bold">PT MOZZ CITRA INDONESIA</h1>
        </div>
        <div className="w-1/2 flex align-center justify-center">
          <p className="text-md font-weight-600 w-[50%]">
